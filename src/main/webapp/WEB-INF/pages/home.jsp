...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/bootstrap.min.css">
           <link rel="search" href="<%=request.getContextPath()%>/resources">
...
<%--                </sec:authorize>--%>
    ...
    <header id="header" class="site-header header-scrolled position-fixed text-black bg-light"style="top: 240px">
                                ...
                                <div class="user-items">
                                    <ul class="d-flex justify-content-end list-unstyled">
                                        <li class="search-item">
                                            <form:form action="${pageContext.request.getContextPath()}/search" method="get">
                                                <div class="input-group">
                                                    <input style="width: 400px;" name="searchInput" type="text" class="form-control" placeholder="Search by product name or category..."/>
                                        ...
                                        <li class="nav-item dropdown" style="width: 300px;">
                                            ...
                                            <ul class="dropdown-menu position-absolute" style="top:100px;">
...
<header id="header" class="site-header header-scrolled position-fixed text-black bg-light"style="top: 25px">
    <jsp:include page="user/countdown.jsp"/>
</header>

    <section id="billboard" class="position-relative overflow-hidden bg-light-blue" style="top: 330px">
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-md-6">
                                <div class="banner-content">
                                    ...
                                    <a href="cart" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Shop Product</a>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="image-holder">
                                    <img src="resources/images/banner-image.png" alt="banner">
                                </div>
                            </div>
                        </div>
                    </div>
...
<%--                            <td>${product.price}</td>--%>
<%--                            <td><img src="${pageContext.request.contextPath }/resources/static/images/bai5.jpg" width="50"></td>--%>
        ...
        <div class="container">
            <div class="row">
                <div class="display-header d-flex justify-content-between pb-3">
                    ...
                    <div class="btn-right">
                        <a href="search?searchInput=smart+phone" class="btn btn-medium btn-normal text-uppercase">Go to Shop</a>
                    </div>
                </div>
<%--                <c:forEach var="product" items="${productList}" varStatus="index">--%>
...
<%--                                        </c:forEach>--%>
                                    ...
                                    <img src="${pageContext.request.contextPath }/getProductPhoto/<c:out value='${product.id}'/>"alt="product-item" class="img-fluid">
                                </div>
                        ...
                        <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 5" style="width: 315px; margin-right: 20px;">
                            <div class="product-card position-relative">
                                <div class="image-holder">
                                    <img src="${pageContext.request.contextPath }/getProductPhoto/<c:out value='${product}'/>" alt="product-item" class="img-fluid">
                                </div>
                                <div class="cart-concern position-absolute">
                                    <div class="cart-button d-flex">
                                        <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
                        ...
                        <div class="swiper-slide" role="group" aria-label="3 / 5" style="width: 315px; margin-right: 20px;">
                            <div class="product-card position-relative">
                                <div class="image-holder">
                        ...
                        <div class="swiper-slide" role="group" aria-label="4 / 5" style="width: 315px; margin-right: 20px;">
                            <div class="product-card position-relative">
                                <div class="image-holder">
                        ...
                        <div class="swiper-slide" role="group" aria-label="5 / 5" style="width: 315px; margin-right: 20px;">
                            <div class="product-card position-relative">
                                <div class="image-holder">
...
<%--        </c:forEach>--%>
    ...
    <section id="watch-products" class="product-store position-relative padding-large no-padding-top">
        <div class="container">
            <div class="row">
                <div class="display-header d-flex justify-content-between pb-3">
                    <h2 class="display-7 text-dark text-uppercase">Smart Watches</h2>
                    <div class="btn-right">
                        <a href="search?searchInput=smart+watch" class="btn btn-medium btn-normal text-uppercase">Go to Shop</a>
                    </div>
                </div>
<%--                <c:forEach var="product" items="${productList}" varStatus="index">--%>
<%--                <c:set var="product" value=""></c:set>--%>
