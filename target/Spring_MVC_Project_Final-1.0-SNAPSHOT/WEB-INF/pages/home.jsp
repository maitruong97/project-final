...
<%--                            </li>--%>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="user/cart" class="dropdown-item">Smart Phones</a>
                                    </li>
                                    <li>
                            ...
                            <li class="nav-item">
                                <div class="user-items ps-5">
                                    <ul class="d-flex justify-content-end list-unstyled">
                                        <li class="search-item pe-3">
                                            <form:form action="${pageContext.request.getContextPath()}/search" method="get">
                                                <div class="input-group">
                                                    <input name="searchInput" type="text" class="form-control" placeholder="Search by product name or category..."/>
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link me-4 dropdown-toggle link-dark" data-bs-toggle="dropdown" href="myCart" role="button" aria-expanded="false">SHOPPING CART</a>
                                            <ul class="dropdown-menu">
